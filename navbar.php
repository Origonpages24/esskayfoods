        ...
        <ul class="navbar-nav justify-content-left flex-grow-1 pe-3" style="padding-left: 20px">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="shop.php">Coffee</a></li>
              <li><a class="dropdown-item" href="shop.php">Pappadam</a></li>
              <li><a class="dropdown-item" href="shop.php">Vadam</a></li>
              <li><a class="dropdown-item" href="shop.php">Karuvadam</a></li>
              <li><a class="dropdown-item" href="shop.php">Kondattam</a></li>
            </ul>
          </li>
          <li class="nav-item">
